...
const Telegram = async () => {
    return (
        <div className="rounded-lg p-4 border dark:bg-gray-900">
            ...
            <Button asChild className="flex w-full items-center space-x-2 bg-green-700 hover:bg-green-700 text-white hover:text-white font-medium px-4 py-2 rounded cursor-pointer">
